    ...
    <main className="min-h-screen w-full max-w-md mx-auto bg-surface flex flex-col relative overflow-hidden">
      ...
      <header className="flex items-center justify-between px-6 py-4 bg-surface/80 backdrop-blur-xl border-b border-border z-20 sticky top-0">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-lg font-bold leading-tight text-primary">Community BBQ</h2>
            <div className="flex items-center gap-2">
              <div className="w-2 h-2 bg-accent rounded-full animate-pulse" />
              <span className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest">Live Discussion</span>
            </div>
          </div>
        </div>
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-8 hide-scrollbar">
        <div className="flex justify-center">
          <span className="px-4 py-1.5 bg-muted rounded-full text-[10px] font-bold text-muted-foreground uppercase tracking-widest">Today, 10:23 AM</span>
        </div>
        ...
        <div className="flex gap-3">
          ...
          <div className="space-y-1 max-w-[80%]">
            <div className="flex items-center gap-2">
              ...
              <span className="px-2 py-0.5 bg-accent/10 text-accent text-[8px] font-bold rounded-full uppercase tracking-widest">Participating</span>
            </div>
            <div className="bg-muted p-4 rounded-2xl rounded-tl-none border border-border">
              <p className="text-sm font-medium leading-relaxed text-primary">Has anyone arrived at the park yet? I&apos;m bringing extra napkins!</p>
            </div>
            <span className="text-[10px] font-bold text-muted-foreground">10:24 AM</span>
          </div>
        </div>
        ...
        <div className="flex flex-col items-end gap-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] font-bold text-muted-foreground">10:30 AM</span>
          </div>
        </div>
        ...
        <div className="flex gap-3">
          ...
          <div className="space-y-3 w-full max-w-[80%]">
            <div className="space-y-1">
              ...
              <div className="bg-muted p-4 rounded-2xl rounded-tl-none border border-border">
                <p className="text-sm font-medium leading-relaxed">Wow that looks amazing! I&apos;m about 5 mins away.</p>
              </div>
              <div className="flex items-center gap-2">
                <span className="text-[10px] font-bold text-muted-foreground">10:32 AM</span>
            ...
            <Link href="/thread/1">
              <div className="bg-muted/50 border border-border rounded-2xl p-4 space-y-3 relative group hover:bg-muted transition-colors">
                <div className="flex justify-between items-center">
                  <h4 className="text-[10px] font-black uppercase tracking-widest text-muted-foreground">Thread: Parking</h4>
                  <ExternalLink className="w-3 h-3 text-muted-foreground" />
                </div>
                <div className="flex gap-3">
                  <span className="px-2 py-0.5 bg-surface text-[8px] font-bold rounded-full border border-border h-fit">Original</span>
                  <p className="text-xs font-bold text-muted-foreground line-clamp-1">Is there free parking near the entrance?</p>
                </div>
                <div className="flex -space-x-2 grayscale">
                  {[1, 2, 3].map(i => (
                    <div key={i} className="w-6 h-6 rounded-full border-2 border-surface overflow-hidden">
                      <Image src={`https://picsum.photos/seed/u${i}/50/50`} alt="User" width={24} height={24} referrerPolicy="no-referrer" />
                    </div>
                  ))}

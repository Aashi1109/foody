      ...
      <div className="flex-1 px-6 py-8 flex flex-col items-center justify-center">
        <div className="w-full max-w-md space-y-8 flex flex-col items-center">
          <div className="text-center space-y-2 w-full">
            ...
            <p className="text-sm text-muted-foreground font-medium">Current: alex.johnson@example.com</p>
          </div>

          <div className="w-full space-y-6">
            <div className="space-y-2">
              <label className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground ml-1 sr-only">New Email Address</label>
              <Input 

    ...
    <main className="min-h-screen w-full max-w-md mx-auto bg-surface flex flex-col">
      ...
      <div className="flex-1 px-6 py-8 flex flex-col items-center">
        <div className="mb-8 flex flex-col items-center">
          ...
          <p className="text-sm text-muted-foreground font-medium">Tap to change photo</p>
        </div>
        ...
        <form className="w-full space-y-6">
          ...
          <div className="space-y-2">
            ...
            />
            <p className="text-[10px] text-muted-foreground font-bold text-right mt-1">102 / 160</p>
          </div>
        </form>
      </div>
